...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function __construct()
    {
        ...
        $this->setTemplateDir('./app/view')
            ...
            ->setConfigDir('./app/other/configs');
        /* $smarty->template_dir="./app/view";//设置模版目录
        $smarty->compile_dir="./app/other/templates_c";//设置编译目录必选
        $smarty->cache_dir="./app/other/cache";//缓存文件夹可选为减轻压力 */
